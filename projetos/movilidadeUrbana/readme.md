...
| Altitude        |     Orientação    |
| Latitude        |     Orientação    |
|Número de Viagens|     Tiempo        |

Geração de Dados Sintéticos:

* Empregar uma Rede Generativa Adversarial Profunda (GAN) para gerar dados sintéticos de velocidade de ônibus. [2]
* Treinar o modelo GAN utilizando os dados do mundo real pré-processados do ônibus elétrico da UNICAMP em 2022. Esse processo de treinamento permite que o modelo capture os padrões e relações subjacentes presentes nos dados reais.
...
Camadas: Apenas camadas MLP (Perceptron Multicamada) com regularização L2.
Otimizadores:
Gerador e Discriminador: Adam
Funções de Perda:
Gerador e Discriminador: Entropia Cruzada Binária (BinaryCrossentropy)

![modelo4](https://github.com/teaching-FEEC/dgm-2023.2/assets/35360195/5e9a8c08-3755-4763-983a-fe4f34884e12)

Variante 2: LSTM + GRU
Gerador e Discriminador:
Camadas: Combinação de LSTM e GRU para processamento sequencial com regularização L2.
Otimizadores:
Gerador e Discriminador: Adam
Funções de Perda:
Gerador: Erro Quadrático Médio (MSE)
Discriminador: Entropia Cruzada Binária (BinaryCrossentropy)

![modelo2](https://github.com/teaching-FEEC/dgm-2023.2/assets/35360195/cda5b866-8c81-4dcb-9762-f02e8256b370)

Variante 3: Conv1D
Gerador e Discriminador:
Camadas: Camadas Conv1D para extração de características com regularização L2.
Otimizadores:
Gerador: Adam
Discriminador: RMSprop
Funções de Perda:
Gerador e Discriminador: Entropia Cruzada Binária (BinaryCrossentropy)

![generated_sequence_21_1](https://github.com/teaching-FEEC/dgm-2023.2/assets/35360195/2b4d48fa-8c7a-4012-a56c-6fc2f3d6d7d1)


Variante 4: MLP + LSTM + GRU
Gerador e Discriminador:
Camadas: Combinação de MLP, LSTM e GRU com regularização L2.
Otimizadores:
Gerador e Discriminador: Adam
Funções de Perda:
Gerador: Erro Quadrático Médio (MSE)
