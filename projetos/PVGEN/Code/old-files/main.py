...
# ------------------------------------------------------------------------------------------------------------------
# 50 days picked randomly for the VS and TEST sets
#
# A multi-output NF:
...
# ------------------------------------------------------------------------------------------------------------------
samples_per_day = 24
data = load_data(path_name='df_power.csv', test_size=50, random_state=0, samples_per_day=samples_per_day)
ylim_loss = [-50, 50]
ymax_plf = 2
ylim_crps = [0, 10]
nb_zones = 1
...
for config in [cf_AN_M, cf_UMNN_M]:
    ...
    quantiles_and_evaluation(dir_path=dir_path, s_VS=s_VS, s_TEST=s_TEST, N_q=N_q, df_y_VS=df_y_VS, df_y_TEST=df_y_TEST, name=name, ymax_plf=ymax_plf, ylim_crps=ylim_crps, nb_zones=nb_zones)