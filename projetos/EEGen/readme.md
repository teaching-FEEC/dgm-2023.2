...
> |--|--|--|
> | Alexandre Herrero Matias  | 223665  | Computation Engineering|
> | Maria Julia De Castro Villafranca Garcia | 183575  | Eletrical Engineering|
...
![Abstract](./references/eeg_freqs.png)
...
-->
The main motivation for this project comes from the fact that, coupled with artificial intelligence techniques, the applicability of EEG data is vast. Within the scope of Motor Imagery (MI), such EEG data allows people with severe paralysis to draw [[7]](#referências-bibliográficas), to treat epilepsy [[8]](#referências-bibliográficas) and also for games [[9]](#referências-bibliográficas) and vehicle use [[10]](#referências-bibliográficas). 
...
Electroencephalogram (EEG) data qualifies as medical data and, therefore, is not easy to collect and is not distributed in large quantities. This is especially true when seeking specific mechanisms for extracting information from brain activity. In this regard, we aim to develop an EEG data generation system with the idea that such data will assist in BCI research. The generated data should adhere to the model of extracting information from brain activity known as motor imagery.

A video presentation of the proposal can be accessed [aqui](https://youtu.be/mS_asNZQ8po).
